...
public class main {
	...
	public static String[] gettitleofpids(String inp) {
		...
		try {
			...
			WebElement hasNext = driver.findElement(By.linkText("View more comments�"));
			while (hasNext.getAttribute("innerHTML").length() > 20) {
				...
				driver.findElement(By.linkText("View more comments�")).click();
				TimeUnit.SECONDS.sleep(5);
				hasNext = driver.findElement(By.linkText("View more comments�"));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
